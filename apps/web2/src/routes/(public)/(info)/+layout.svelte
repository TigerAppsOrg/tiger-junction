...
<main class="max-w-screen flex min-h-screen">
    <div class="overlay flex w-full flex-1 flex-col items-center pt-2">
        <LandingHeader />
        <slot />
...
<style>
    main {
        background-image: radial-gradient(
            ...
            radial-gradient(21% 37% at 72% 23%, #ebb6f0aa 12%, #ff6b6b00 100%),
