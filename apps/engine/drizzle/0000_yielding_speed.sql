...
ALTER TABLE "course_instructor_map" ADD CONSTRAINT "course_instructor_map_instructor_id_instructors_emplid_fk" FOREIGN KEY ("instructor_id") REFERENCES "public"."instructors"("emplid") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "courses_listing_id_term_index" ON "courses" USING btree ("listing_id","term");