...
Tier 1: Claude Opus 5 — $3.00 budget
Tier 2: Claude Sonnet 5 — $1.00 budget (auto-downgrade when Tier 1 exhausted)
...
TIER1_MODEL = "anthropic/claude-opus-5"
TIER2_MODEL = "anthropic/claude-sonnet-5"
TIER1_BUDGET = 3.00
TIER2_BUDGET = 1.00
