...
<div class="text-left h-fit w-full px-4 pb-8 pt-4 max-w-7xl">
    ...
    <p>
        At TigerJunction, we are committed to protecting the privacy and personal information of our users. This Privacy Policy outlines how we collect, use, disclose, and safeguard your information when you use our website. By using TigerJunction, you consent to the practices described in this policy.
    </p>
    ...
    <p>
        We Collect a. Personal Information: When you register for 
        TigerJunction, we collect your name, Princeton University 
        email address, and other profile information you provide. 
        b. Usage Data: We may collect information about how you use 
        our website, including your browsing actions, pages visited, 
    ...
    <p>
        We use the information we collect to: a. To provide and maintain the website and its features. b. To personalize your experience and deliver content and product offerings relevant to your interests. c. To provide customer support and respond to your inquiries. d. To detect, prevent, and address technical issues and ensure the security of our website. e. To communicate with you about updates, offers, and other relevant information related to TigerJunction.
    </p>
    ...
    <p>
        ...
        services to you. b. Legal Requirements: We may disclose your 
        information if required to do so by law or in response to a 
        subpoena or court order. c. We do not sell, rent, trade, or
        otherwise transfer your information to outside parties 
    ...
    <p>
        ...
        time. Your continued use of TigerJunction after we post any 
